...
{
    std::cout << "AppSuperballContact" << std::endl;
   ...
   tgWorld world(config, ground); 
    ...
    SuperballModelContact* myModel =
      new SuperballModelContact(segments);
    ...
    SpineFeedbackControl* const myControl =
      new SpineFeedbackControl(control_config, suffix, "bmirletz/Superball/");
