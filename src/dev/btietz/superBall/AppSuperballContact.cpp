...
/**
 * @file AppSuperBallContact.cpp
 * @brief Implementing SUPERball.
...
{
    std::cout << "SuperBallContact" << std::endl;
    ...
    SuperballModelContact* const myModel = new SuperballModelContact(segments);
