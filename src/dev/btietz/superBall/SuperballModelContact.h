...
#ifndef SUPERBALL_MODEL_CONTACT_H
#define SUPERBALL_MODEL_CONTACT_H
 ...
 */
class SuperballModelContact : public BaseSpineModelLearning
{
public: 

    SuperballModelContact(int segments);

    virtual ~SuperballModelContact();
