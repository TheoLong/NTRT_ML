...
//
    ...
    //Node for payload
    super.addNode(0,0,0, "payload"); //12
    ...
    super.addPair(6, 12, "muscle");
    super.addPair(7, 12, "muscle");
    super.addPair(8, 12, "muscle");
    super.addPair(9, 12, "muscle");
    super.addPair(10, 12, "muscle");
    super.addPair(11, 12, "muscle");
