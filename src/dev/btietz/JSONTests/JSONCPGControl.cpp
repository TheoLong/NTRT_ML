...
void JSONCPGControl::onSetup(BaseSpineModelLearning& subject)
{
    ...
    std::cout<<"this is ok, before setup"<<endl;
    setupCPGs(subject, nodeParams, edgeParams);
    std::cout<<"this is ok, after setup"<<endl;
                            ...
                            (Json::Value edgeParam)
{
    ...
    */
    ...
    {
        std::cout << "get in i loop"<<std::endl;
        std::cout << *edgeIt <<std::endl;
        while(j < m_config.theirMuscles)
        {
             std::cout << "get in j loop"<<std::endl;
             std::cout << *edgeIt <<std::endl;
            while(k < m_config.ourMuscles)
            {
                std::cout << "get in k loop"<<std::endl;
                std::cout << *edgeIt <<std::endl;
                if (edgeIt == edgeParam.begin())
                {
                    std::cout << "get in if loop"<<std::endl;
                    std::cout << *edgeIt <<std::endl;
                ...
                {
                    std::cout << "get in else loop"<<std::endl;
                    std::cout << *edgeIt <<std::endl;
                    if (i == 1 && j == k)
                    {
    ...
    std::cout<<"passed assertion"<<endl;
