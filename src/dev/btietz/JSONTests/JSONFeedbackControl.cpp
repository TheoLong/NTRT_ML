...
{
    std::cout<< "begin of get mus loop"  <<std::endl;
    ...
    std::cout<< "begin of det connectivity"  <<std::endl;
    ...
    std::cout<< "end of set connectivity"  <<std::endl;
