                       ...
                       array_4D edgeParams) 
{
    ...
    std::cout<<m_nodeNumber<<std::endl;
    ...
    std::cout<< "beg of for"  <<std::endl;
    std::cout<<"total #ofString is: "<<allStrings.size()<<std::endl;
    for (int i = 0; i < allStrings.size(); i++)
    {
        std::cout<<"i'm in string#: "<<i<<std::endl;
        ...
        {   
                ...
                m_pToBody == theirFromGroup)
            {
                ...
                std::cout<<"theirmus: "<<theirMuscle<<" musSize: "<<muscleSize<< "rp: "<<rp<<std::endl;
                ...
                else
                {
                    ...
                    // weights.push_back(edgeParams[0][j][k][0]);
                    // phases.push_back(edgeParams[0][j][k][1]); 
                    std::cout<< "7"  <<std::endl;
